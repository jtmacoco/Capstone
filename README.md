...
> A Full-stack Web Application for Time-Series Stock Forecasting

![example](./website/videos/stock-example.gif)
...
- Interactive Dashboards: Visualizes historical trends vs. predicted prices using Plotly.
...
Old hosting url might start it back up again </br>
~~website:https://www.stock-predictor.com/~~
